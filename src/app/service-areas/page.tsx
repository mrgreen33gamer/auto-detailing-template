...
// GlossLab Auto Detailing — Service Areas Page
'use client';
...
const SERVICE_AREAS = [
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: "Serving Woodway's residential neighborhoods with the same flat-rate pricing and Satisfaction Re-Detail Guarantee as every other area we cover.",
    highlights:  ['Flat-rate pricing', 'Satisfaction Re-Detail Guarantee', 'product-certified'],
  },
  {
    city:        'Bellmead',
    slug:        'bellmead-tx',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Rural and residential auto detailing service for the China Spring area. We make the drive — flat-rate pricing applies just the same.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Auto Detailing repair, installation, and upgrades for Killeen and Fort Cavazos area homes and businesses. Military-friendly scheduling.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Full-service auto detailing coverage for Temple. Medical district and surrounding neighborhoods served. Full residential and commercial auto detailing.',
...
const faq = [
  ...
  {
    question: 'Do you work on commercial auto detailing in all areas?',
    answer: 'Yes — light commercial auto detailing for restaurants, offices, retail spaces, and small warehouses is within scope across all our coverage areas. Call to discuss your specific project and location.',
  },
  {
    ...
    <main className={styles.page}>
        ...
        <div className={styles.heroInner}>
          ...
          >
            <div className={styles.heroBadge}>
              ...
              Central Texas Auto Detailing — Since 2011
            </div>
            ...
            <p className={styles.heroSub}>
              Based in Waco, serving all of Central Texas. Flat-rate pricing, product-certified auto detailing technicians, and a Satisfaction Re-Detail Guarantee — no matter where you are.
            </p>
            <div className={styles.heroActions}>
              <a href="tel:+12549501616" className={styles.heroCTAPrimary}>
        ...
        <div className={styles.areasSectionInner}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSub}>
              Click any city to see local service details, common auto detailing issues in your area, and what to expect from our team.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.areaFooter}>
                    <a href="tel:+12549501616" className={styles.areaCallBtn}>
      ...
      <section className={styles.unlisted}>
        <div className={styles.unlistedInner}>
          ...
          <a href="tel:+12549501616" className={styles.unlistedCTA}>
            Call (254) 950-1616
          </a>
        </div>
      </section>
      ...
      <CTABanner
        ...
        subline="Same-day service available across Central Texas. Flat-rate pricing, Satisfaction Re-Detail Guarantee, no contracts ever."
