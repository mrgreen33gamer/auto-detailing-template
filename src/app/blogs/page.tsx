    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>GlossLab Auto Detailing - Blog Center</h1>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Need reliable detailing service in Central Texas?
            </p>
            <p className={styles.blogCTABody}>
              We've been keeping Waco-area vehicles and fleets comfortable with expert heating, cooling, and maintenance since 2015. Free estimate, no obligations.
            </p>
