...
// GlossLab Auto Detailing — Contact Page (unique build, not just a form import)
...
// ── Service options ────────────────────────────────────────────────────────────
const SERVICES = [
  'Full Detail', 'Ceramic Coating', 'Paint Correction',
  'Interior Detail', 'Headlight Restoration', 'Maintenance Detail',
  'Express Detail', 'Other / Not Sure',
];

// ── FAQ data ──────────────────────────────────────────────────────────────────
const faq = [
  {
    question: "What's the fastest way to reach you for an priority?",
    answer: "Call us directly at (254) 950-1616. We answer 7 days a week including evenings. For a genuine detailing priority in Central Texas, call — don't wait on a form response.",
  },
  {
    question: 'How quickly can someone come out?',
    answer: "Same-week booking is available most days during business hours. Evening and weekend priority calls are dispatched within 1–2 hours. We'll give you an honest ETA when you call — not a 4-hour window.",
  },
  {
    question: 'Do you charge for the diagnostic visit?',
    answer: 'We charge a standard diagnostic fee for non-priority visits, which is waived when you proceed with the repair. Priority dispatch calls have a separate fee. We\'ll confirm the amount when you schedule.',
  },
  {
    question: 'Do you work on commercial detailing systems?',
    answer: 'Yes — light commercial detailing for restaurants, offices, retail spaces, and small warehouses is within our scope. Call to discuss your specific system and location.',
  },
  {
  ...
  return (
    <main className={styles.page}>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@glosslabdetail.com',
                  href:      'mailto:hello@glosslabdetail.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '2701 Franklin Ave, Waco TX 76701',
                ...
                },
                {
                  ...
                  label:     'Hours',
                  value:     'Mon–Fri 7am–6pm · Sat 8am–2pm · Priority 24/7',
                  href:      null,
                  eventType: null,
                  eventLabel: null,
                },
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose GlossLab Auto Detailing</p>
              {[
                'Flat-rate pricing — written quote before we start',
                '1-year parts & labor warranty on every repair',
                'product-certified technicians only',
                'Same-week booking, 7 days a week',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A licensed GlossLab Auto Detailing detailing technician will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12549501616">(254) 950-1616</a>.
                  </p>
      ...
      <CTABanner
        ...
        subline="Call (254) 950-1616 — we answer 7 days a week, evenings included. Priority service available across Central Texas."
        primaryText="Call (254) 950-1616"
        primaryLink="tel:+12549501616"
        secondaryText="Send a Text"
        secondaryLink="sms:+12549501616"
      />
