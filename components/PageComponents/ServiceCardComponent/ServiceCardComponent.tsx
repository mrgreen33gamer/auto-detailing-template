...
export default function ServiceCardComponent({
  cards,
  heading    = 'Everything Your Vehicle Finish Needs',
  subheading = 'From emergency auto detailings to annual maintenance plans, GlossLab handles it all — on time, on price.',
