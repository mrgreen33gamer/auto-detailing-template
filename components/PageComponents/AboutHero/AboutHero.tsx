      ...
      <div className={styles.heroContainer}>
        ...
        >
          ...
          <h1 className={styles.heroTitle}>
            Central Texas detailing<br />
            <em>Done Right.</em><br />
            Every Time.
          </h1>
          <p className={styles.heroSubtitle}>
            GlossLab Auto Detailing has been keeping vehicles looking their best in{' '}
            <strong>{cityName}</strong> and across Central Texas for over 11 years —
          ...
          <div className={styles.imageFrame}>
            <div className={styles.imageWrapper}>
              <Image
                ...
                alt="GlossLab Auto Detailing — Waco, Texas detailernicians"
                fill
            ...
            <div className={styles.trustCard}>
              ...
              <div className={styles.trustCardText}>
                <span className={styles.trustCardTitle}>GlossLab Auto Detailing</span>
                <span className={styles.trustCardSub}>Waco's Most Trusted detailing</span>
              </div>
            </div>
          </div>
        </motion.div>
