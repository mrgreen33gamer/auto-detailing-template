...
export default function FAQ({ cityName, faq, title = 'detailing Service FAQs' }: FAQProps) {
    ...
    <section className={styles.section} aria-label="Frequently Asked Questions">
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          {cityName && (
            <p className={styles.subtitle}>Common questions from {cityName} drivers and businesses.</p>
          )}
        </div>
