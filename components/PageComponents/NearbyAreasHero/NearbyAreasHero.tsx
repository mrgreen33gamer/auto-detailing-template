...
export default function NearbyAreasHero({
  ...
  const displayHeadline = headline ?? `detailing Service in ${cityName}, TX`;
  const displayDesc     = description ??
    `GlossLab Auto Detailing provides fast, reliable auto detailing service to ${cityName} and all surrounding communities. Licensed technicians, flat-rate pricing, Re-Detail Guarantee on every job.`;
    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <a href="tel:+12549501616" className={styles.phoneBtn}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
